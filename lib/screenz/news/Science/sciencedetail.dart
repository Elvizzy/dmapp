...
import '../../../widget/newsdetailwidget.dart';

class ScienceNewsDetailScreen extends StatelessWidget {
  final Articles newsArticle;

  const ScienceNewsDetailScreen({Key? key, required this.newsArticle})
      : super(key: key);
