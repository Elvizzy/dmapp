...
import 'package:dmapp/screenz/news/Science/sciencedetail.dart';
...
class Sciencenewslistscreen extends StatelessWidget {
  ...
  ScienceNewsController sciencenewsController =
      Get.find<ScienceNewsController>();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        return sciencenewsController.stillFetching.value
            ? const Center(child: CircularProgressIndicator())
            : NewsListWidget(
                color: Colors.lightBlueAccent,
                appBarTitleText: 'Science News',
                titleText: sciencenewsController.scienceNewsList[0].title!,
                headerImage:
                    sciencenewsController.scienceNewsList[0].urlToImage!,
                sliverDelegate: SliverChildBuilderDelegate(
                  ((context, index) {
                    var sciencenews =
                        sciencenewsController.scienceNewsList[index];
                    return Column(
                      children: [
                        Material(
                          elevation: 4,
                          child: Container(
                            child: Padding(
                              ...
                              child: InkWell(
                                onTap: () {
                                  Get.to(ScienceNewsDetailScreen(
                                      newsArticle: sciencenews));
                                },
                                child: Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                            fit: BoxFit.cover,
                                            image: NetworkImage(sciencenews
                  ...
                  childCount: sciencenewsController.scienceNewsList.length,
                ),
              );
      }),
