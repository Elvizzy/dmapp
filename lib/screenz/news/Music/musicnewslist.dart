...
import 'package:dmapp/screenz/news/Music/musicdetail.dart';
...
class Musicnewslistscreen extends StatelessWidget {
  ...
  MusicNewsController musicnewsController = Get.find<MusicNewsController>();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('MUSIC NEWS'),
        centerTitle: true,
      ),
      body: Obx(() {
        return musicnewsController.stillFetching.value
            ? const Center(child: CircularProgressIndicator())
            : NewsListWidget(
                color: Colors.purple,
                appBarTitleText: 'Music News',
                titleText: musicnewsController.musicNewsList[0].title!,
                headerImage: musicnewsController.musicNewsList[0].urlToImage!,
                sliverDelegate: SliverChildBuilderDelegate(
                  ((context, index) {
                    var musicnews = musicnewsController.musicNewsList[index];
                    return Column(
                      children: [
                        Material(
                          elevation: 4,
                  ...
                  childCount: musicnewsController.musicNewsList.length,
                ),
              );
      }),
